...
def set_language(call: types.CallbackQuery):
    ...
    bot.send_message(call.message.chat.id, lang_util.get_translation("Language set to "+lang_util.get_lang_name(lang_code), lang_code), reply_markup=km.get_menu_markup())
